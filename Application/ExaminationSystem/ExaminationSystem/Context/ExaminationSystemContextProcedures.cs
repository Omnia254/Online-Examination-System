...
namespace ExaminationSystem.Context
{
    ...
    public partial class ExaminationSystemContextProcedures : IExaminationSystemContextProcedures
    {
        ...
        public virtual async Task<List<ExamCorrectionResult>> ExamCorrectionAsync(int? ExId, int? StId, int? CID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<ExamCorrectionResult>("EXEC @returnValue = [dbo].[ExamCorrection] @ExId, @StId, @CID", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<INSINSERTResult>> INSINSERTAsync(string COL2DATA, string COL3DATA, DateOnly? COL4DATA, string COL5DATA, string COL6DATA, int? COL7DATA, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
        ...
        public virtual async Task<List<UPDATEINSTRUCTORResult>> UPDATEINSTRUCTORAsync(int? InstructorID, string FirstName, string LastName, DateOnly? HireDate, string PhoneNumber, string Email, int? DepartmentID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
