...
namespace ExaminationSystem.Context
{
    public partial interface IExaminationSystemContextProcedures
    {
        ...
        Task<List<GetDistinctExamIDsResult>> GetDistinctExamIDsAsync(int? CourseID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<GetEnrolledCoursesByStudentIDResult>> GetEnrolledCoursesByStudentIDAsync(int? StudentID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<GetEnrolledStudentCoursesResult>> GetEnrolledStudentCoursesAsync(int? StudentID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<int> INSERTCOURSEAsync(string COL2DATA, int? COL3DATA, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<int> InsertTOPICAsync(string COL2DATA, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<INSINSERTResult>> INSINSERTAsync(string COL2DATA, string COL3DATA, DateTime? COL4DATA, string COL5DATA, string COL6DATA, int? COL7DATA, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<UPDATEINSTRUCTORResult>> UPDATEINSTRUCTORAsync(int? InstructorID, string FirstName, string LastName, DateTime? HireDate, string PhoneNumber, string Email, int? DepartmentID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
